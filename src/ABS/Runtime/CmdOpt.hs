...
data CmdOpt = CmdOpt {
    ...
    , j_ignore :: Int          -- ^ Ignore. This field is used internally only by the cmdopts of test-suite
...
cmdOptSpec = CmdOpt { 
             ...
             , j_ignore = def &= explicit &= name "j" &= help "Ignore. This field is used internally only by the cmdopts of test-suite"
             }
